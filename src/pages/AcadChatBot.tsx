...
import type { ChatMessage } from "@/types/acad.chatbot";

export default function AcadChatBot() {
	...
	const [messages, setMessages] = useState<ChatMessage[]>([
		{
			id: 1,
			sender: "bot",
			content: "Hola 👋 Soy el Bot Académico. Pregunta lo que quieras sobre tus ramos.",
		},
	]);
			...
			>
				<Stack gap={1}>
					...
					<Text fontSize="lg" color="#eceaeaff">
						Haz preguntas sobre tus ramos y obtén ayuda al instante.
					</Text>
				</Stack>
